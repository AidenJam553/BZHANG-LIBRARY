...
/**
 * Reason validation function that checks if the reason contains the word 'friend'.
...
const validateReason = (blur) => {
  ...
  if (reasonText.includes('friend')) {
    if (blur) reasonSuccess.value = 'Great to have a friend'
  } else {
    reasonSuccess.value = null
  }
}
</script>
    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <!-- Third row: Australian Resident checkbox -->
          <div class="row mb-3">
            <div class="col-12">
          ...
          <div class="mb-3">
            ...
            ></textarea>
            <div v-if="reasonSuccess" class="text-success mt-2">
              {{ reasonSuccess }}
            </div>
          </div>
